...
const PreviewModal: React.FC<PreviewModalProps> = ({
  ...
  }, [isOpen, htmlContent, markdownContent, mode]);
  ...
  const handleDownloadImage = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(tempElement, {
        ...
        width: 800,
        height: tempElement.scrollHeight + 80, // Add padding
        scrollX: 0,
        scrollY: 0,
        windowWidth: 800,
      ...
      document.body.removeChild(tempElement);
        ...
        const quality = imageFormat === 'png' ? 1.0 : 0.95; // PNG doesn't use quality, others do
